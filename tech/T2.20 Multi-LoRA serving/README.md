...
When does adapter churn dominate the savings from sharing base weights? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
