# T1.10-L01 — Shape, occupancy and tensor cores

Status: planned, not executed · Scope: core · Level: medium · Hardware: G1 · Dependencies: T1.10-L00

Read the [environment and measurement contract](../environment.md) before using paid hardware.

## Engineering question

How do matrix shape and precision change achieved throughput and occupancy?
...
1. Create `results/T1.10-L01/` and save the exact environment, command, version/digest and workload manifest there.
2. Build a PyTorch GEMM sweep with correctness checks and profiler-visible ranges.
...
- Independent conditions: square and skinny shapes; FP32, TF32/BF16 where supported; warm repetitions.
...
- Measure: latency, achieved FLOP/s, occupancy proxy, tensor-core evidence and error.
...
Falsifier: **Speedup is attributed to tensor cores without profiler or precision evidence.**
