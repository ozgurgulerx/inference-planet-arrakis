...
|---|---|---|---|
| T1.19-L00 | [NCCL communicator inventory](lab-00-foundation/README.md) | intro / core | G2 |
| T1.19-L01 | [NCCL size curve](lab-01-controlled-sweep/README.md) | medium / core | G2 |
| T1.19-L02 | [Slow-rank diagnosis](lab-02-boundary-case/README.md) | expert / later | G2 isolated processes |

## Intro — A: study/do tasks

- [ ] **T1.19-L00-A** — [NCCL communicator inventory](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G2; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.19-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.19-L01-A** — [NCCL size curve](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G2; dependencies: T1.19-L00.

## Medium — B: completion evidence

- [ ] **T1.19-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.19-L02-A** — [Slow-rank diagnosis](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G2 isolated processes; dependencies: T1.19-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.19-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
