...
- NCCL collectives and point-to-point operations.
...
How do you distinguish a slow rank from an inefficient collective algorithm? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
