...
- launch overhead.
- register pressure.
- persistent kernels and device-side scheduling.

## Changed-case question

When does fusion lose because occupancy, flexibility or debugging costs dominate? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
