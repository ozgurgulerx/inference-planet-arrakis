...
- SLO goodput.
- quality-adjusted precision choices.
- utilization and reservation cost.

## Changed-case question

Can a cheaper GPU increase cost per successful request? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
