...
|---|---|---|---|
| T1.33-L00 | [Attention-state estimator](lab-00-foundation/README.md) | intro / core | CPU |
| T1.33-L01 | [Estimator validation](lab-01-controlled-sweep/README.md) | medium / core | G1 |
| T1.33-L02 | [Throughput changed case](lab-02-boundary-case/README.md) | expert / later | G1; cross-model result observational |

## Intro — A: study/do tasks

- [ ] **T1.33-L00-A** — [Attention-state estimator](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: CPU; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.33-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.33-L01-A** — [Estimator validation](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dependencies: T1.33-L00.

## Medium — B: completion evidence

- [ ] **T1.33-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.33-L02-A** — [Throughput changed case](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; cross-model result observational; dependencies: T1.33-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.33-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
