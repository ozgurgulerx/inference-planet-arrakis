# T1.12-L01 — Measured roofline

Status: planned, not executed · Scope: core · Level: medium · Hardware: G1 · Dependencies: T1.12-L00

Read the [environment and measurement contract](../environment.md) before using paid hardware.

## Engineering question

Does the measured operator move from bandwidth- toward compute-limited as reuse increases?
...
1. Create `results/T1.12-L01/` and save the exact environment, command, version/digest and workload manifest there.
2. Benchmark the same operator shapes with warmups and profiler evidence.
...
- Independent conditions: three reuse/batch points with fixed weights and precision.
...
- Measure: achieved FLOP/s, effective bandwidth, latency and utilization.
...
Falsifier: **Observed scaling contradicts the predicted limiting ceiling.**
