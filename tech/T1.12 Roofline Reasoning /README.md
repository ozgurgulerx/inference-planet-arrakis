...
- phase-specific operational intensity.
- communication and launch limits.

## Changed-case question

What evidence would falsify a bandwidth-bound diagnosis? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
