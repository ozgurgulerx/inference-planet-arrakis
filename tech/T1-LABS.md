...
|---|---|---|---|
| T1.01 | [Lifecycle](T1.01%20LLM%20Inference%20Lifecycle/labs/README.md) | T1.24 | [RDMA fundamentals](T1.24%20RDMA%20Fundamentals%20/labs/README.md) |
| T1.02 | [Transformer architecture](T1.02%20Transformer%20Inference%20Architecture/labs/README.md) | T1.25 | [Memory registration](T1.25%20Memory%20Registration%20/labs/README.md) |
| T1.03 | [KV cache](T1.03%20KV%20Cache%20/labs/README.md) | T1.26 | [InfiniBand](T1.26%20InfiniBand/labs/README.md) |
| T1.04 | [Paged attention](T1.04%20Paged%20Attention%20-%20KV%20Memory%20Management%20/labs/README.md) | T1.27 | [RoCE](T1.27%20RoCE/labs/README.md) |
| T1.05 | [Prefill versus decode](T1.05%20Prefill%20vs%20Decode%20/labs/README.md) | T1.28 | [GPUDirect RDMA](T1.28%20GPUDirect%20RDMA%20/labs/README.md) |
| T1.06 | [Continuous batching](T1.06%20Continous%20Batching%20/labs/README.md) | T1.29 | [KV transfer](T1.29%20KV%20transfer/labs/README.md) |
| T1.07 | [Chunked prefill](T1.07%20Chunked%20Prefill%20/labs/README.md) | T1.30 | [NIXL](T1.30%20NIXL%20/labs/README.md) |
| T1.08 | [Serving metrics](T1.08%20Serving%20metrics/labs/README.md) | T1.31 | [P/D disaggregation](T1.31%20prefill%20/labs/README.md) |
| T1.09 | [Workload characterization](T1.09%20Workload%20Characterization/labs/README.md) | T1.32 | [Quantization](T1.32%20Quantization/labs/README.md) |
| T1.10 | [GPU architecture](T1.10%20GPU%20Architecture%20Basics/labs/README.md) | T1.33 | [GQA/MQA/MLA](T1.33%20GQA%20-%20MQA%20-%20MLA%20/labs/README.md) |
| T1.11 | [GPU memory hierarchy](T1.11%20GPU%20memory%20hierarchy/labs/README.md) | T1.34 | [Flash attention](T1.34%20Flash%20Attention%20-%20Optimised%20Attention/labs/README.md) |
| T1.12 | [Roofline reasoning](T1.12%20Roofline%20Reasoning%20/labs/README.md) | T1.35 | [MoE inference](T1.35%20MoE%20Inference/labs/README.md) |
| T1.13 | [CUDA fundamentals](T1.13%20CUDA%20Fundamentals%20/labs/README.md) | T1.36 | [Speculative decoding](T1.36%20Speculative%20Decoding%20/labs/README.md) |
| T1.14 | [CUDA streams/events](T1.14%20CUDA%20streams%20-%20events/labs/README.md) | T1.37 | [vLLM internals](T1.37%20vLLM%20Internals%20/labs/README.md) |
| T1.15 | [Tensor parallelism](T1.15%20Tensor%20parallelism/labs/README.md) | T1.38 | [SGLang](T1.38%20SGLang%20Architecture/labs/README.md) |
| T1.16 | [Pipeline parallelism](T1.16%20Pipeline%20paralellism/labs/README.md) | T1.39 | [TensorRT-LLM](T1.39%20Tensor-RT%20LLM%20/labs/README.md) |
| T1.17 | [Data parallelism](T1.17%20Data%20parallelism/labs/README.md) | T1.40 | [NVIDIA Dynamo](T1.40%20NVIDIA%20Dynamo%20/labs/README.md) |
| T1.18 | [Expert parallelism](T1.18%20Expert%20parallelism/labs/README.md) | T1.41 | [Profiling](T1.41%20Profiling/labs/README.md) |
| T1.19 | [NCCL](T1.19%20NCCL%20/labs/README.md) | T1.42 | [GPU observability](T1.42%20GPU%20Observability/labs/README.md) |
| T1.20 | [Collectives](T1.20%20Collectives/labs/README.md) | T1.43 | [Bottleneck analysis](T1.43%20Bottleneck%20Analysis/labs/README.md) |
| T1.21 | [PCIe](T1.21%20PCIe/labs/README.md) | T1.44 | [Capacity planning](T1.44%20Capacity%20Planning/labs/README.md) |
| T1.22 | [NVLink/NVSwitch](T1.22%20NVLink%20NVSwitch/labs/README.md) | T1.45 | [Inference economics](T1.45%20Inference%20Economics/labs/README.md) |
| T1.23 | [NUMA](T1.23%20NUMA/labs/README.md) |  |  |
