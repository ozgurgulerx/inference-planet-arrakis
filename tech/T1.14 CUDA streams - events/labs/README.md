# T1.14 — CUDA streams - events — Runpod labs
...
|---|---|---|---|
| T1.14-L00 | [Two-stream ordering](lab-00-foundation/README.md) | intro / core | G1 |
| T1.14-L01 | [Event timing audit](lab-01-controlled-sweep/README.md) | medium / core | G1 |
| T1.14-L02 | [Overlap changed case](lab-02-boundary-case/README.md) | expert / later | G1 |

## Intro — A: study/do tasks

- [ ] **T1.14-L00-A** — [Two-stream ordering](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.14-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.14-L01-A** — [Event timing audit](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dependencies: T1.14-L00.

## Medium — B: completion evidence

- [ ] **T1.14-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.14-L02-A** — [Overlap changed case](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dependencies: T1.14-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.14-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
