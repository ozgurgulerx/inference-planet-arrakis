...
|---|---|---|---|
| T1.30-L00 | [NIXL descriptor lifecycle](lab-00-foundation/README.md) | intro / core | G1/G2 depending backend |
| T1.30-L01 | [Async transfer size curve](lab-01-controlled-sweep/README.md) | medium / core | G2 local transfer; backend conditional |
| T1.30-L02 | [Connector failure and cleanup](lab-02-boundary-case/README.md) | expert / later | G2; isolated processes |

## Intro — A: study/do tasks

- [ ] **T1.30-L00-A** — [NIXL descriptor lifecycle](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1/G2 depending backend; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.30-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.30-L01-A** — [Async transfer size curve](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G2 local transfer; backend conditional; dependencies: T1.30-L00.

## Medium — B: completion evidence

- [ ] **T1.30-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.30-L02-A** — [Connector failure and cleanup](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G2; isolated processes; dependencies: T1.30-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.30-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
