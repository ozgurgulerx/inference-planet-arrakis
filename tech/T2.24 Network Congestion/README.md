...
- Competing KV and collective traffic.
- incast.
- congestion control.
- tail behavior.
...
How would you distinguish congestion from a slow producer rank? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
