...
- All-reduce, all-gather and reduce-scatter.
- all-to-all.
...
Why is an all-reduce benchmark insufficient to predict MoE dispatch performance? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
