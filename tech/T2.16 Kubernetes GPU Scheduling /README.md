# T2.16 — Kubernetes GPU Scheduling
...
Why can free aggregate GPU capacity fail to fit a distributed serving replica? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
