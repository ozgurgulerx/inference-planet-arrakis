...
|---|---|---|---|
| T1.27-L00 | [RoCE evidence inventory](lab-00-foundation/README.md) | intro / core | N2 RoCE conditional |
| T1.27-L01 | [Congestion observation](lab-01-controlled-sweep/README.md) | medium / core | N2 RoCE and counters required |
| T1.27-L02 | [Pause-propagation boundary](lab-02-boundary-case/README.md) | expert / later | Dedicated N2+ fabric; normally blocked on public Pods |

## Intro — A: study/do tasks

- [ ] **T1.27-L00-A** — [RoCE evidence inventory](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: N2 RoCE conditional; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.27-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.27-L01-A** — [Congestion observation](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: N2 RoCE and counters required; dependencies: T1.27-L00.

## Medium — B: completion evidence

- [ ] **T1.27-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.27-L02-A** — [Pause-propagation boundary](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: Dedicated N2+ fabric; normally blocked on public Pods; dependencies: T1.27-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.27-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
