...
- Token and memory budgets.
- phase-specific admission.
- tenant fairness.
- cache admission.

## Changed-case question

How do you reject or defer work before accepted requests violate their SLOs? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
