# T1.09 — Workload Characterization — Runpod labs
...
Semantic owner links: [T1.01-L15](../../T1.01%20LLM%20Inference%20Lifecycle/labs/lab-15-arrival-process/README.md)
...
|---|---|---|---|
| T1.09-L00 | [Workload shape inventory](lab-00-foundation/README.md) | intro / core | CPU |
| T1.09-L01 | [Open versus closed loop](lab-01-controlled-sweep/README.md) | medium / core | G1 |
| T1.09-L02 | [Mixed-trace saturation](lab-02-boundary-case/README.md) | expert / later | G1 |

## Intro — A: study/do tasks

- [ ] **T1.09-L00-A** — [Workload shape inventory](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: CPU; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.09-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.09-L01-A** — [Open versus closed loop](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dependencies: T1.09-L00.

## Medium — B: completion evidence

- [ ] **T1.09-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.09-L02-A** — [Mixed-trace saturation](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dependencies: T1.09-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.09-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
