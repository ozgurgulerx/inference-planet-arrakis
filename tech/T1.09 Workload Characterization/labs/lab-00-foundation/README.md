# T1.09-L00 — Workload shape inventory
...
Which request dimensions must be frozen before a benchmark represents the target workload?
...
1. Create `results/T1.09-L00/` and save the exact environment, command, version/digest and workload manifest there.
2. Build a trace schema for ISL, actual OSL, prefix identity, tenant/class, arrival time, features, finish reason and quality/SLO validity.
...
- Independent conditions: capture or synthesize at least three explicit workload classes.
...
- Measure: distribution tables, correlations, missingness and representative fixtures.
...
Falsifier: **The fixture preserves averages while erasing a tail or correlation that controls capacity.**
