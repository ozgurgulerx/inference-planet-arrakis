# T1.24-L02 — Completion and failure semantics

Status: planned, not executed · Scope: later · Level: expert · Hardware: N2 isolated endpoints · Dependencies: T1.24-L01

Read the [environment and measurement contract](../environment.md) before using paid hardware.

## Engineering question

What remains uncertain when a local completion arrives, and how is a failed peer surfaced?
...
1. Create `results/T1.24-L02/` and save the exact environment, command, version/digest and workload manifest there.
2. Use bounded peer delay/termination with hard timeouts and record completion/error state.
...
- Independent conditions: healthy, delayed and terminated peer.
...
- Measure: local/remote completion evidence, timeout and resource cleanup.
...
Falsifier: **A destructive failure test affects an unowned endpoint or can hang indefinitely.**
