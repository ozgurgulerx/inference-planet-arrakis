...
- transport and streaming backpressure.
- cancellation propagation.

## Changed-case question

What happens to GPU work when a client stops reading its stream? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
