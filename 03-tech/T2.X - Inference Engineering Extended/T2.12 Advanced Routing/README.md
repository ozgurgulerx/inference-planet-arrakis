...
- Prefix and session affinity.
- load and topology.
- predicted completion cost.
- model and adapter switching.

## Changed-case question

When should the router deliberately abandon cache affinity? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
