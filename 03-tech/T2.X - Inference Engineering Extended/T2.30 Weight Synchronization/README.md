...
- Versioned weight transfer.
- synchronization barriers.
- full versus delta updates.
- atomic activation.

## Changed-case question

How do you prevent one request from mixing two policy versions? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
