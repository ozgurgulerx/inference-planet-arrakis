...
- PPO/GRPO/RLHF system roles.
- rollout generation.
- reward and reference costs.
- policy freshness.

## Changed-case question

How does longer generated reasoning change the dominant systems cost of an RL step? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
