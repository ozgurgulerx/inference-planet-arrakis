...
- Checkpoint IO.
- CPU/device staging.
- sharding and initialization.
- readiness and warmup.

## Changed-case question

Why is process startup time different from time to first healthy request? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
