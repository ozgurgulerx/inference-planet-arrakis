...
- ROCm software stack.
- kernel and datatype support.
- distributed communication.
- portability validation.

## Changed-case question

Why is a successful CUDA-to-ROCm port insufficient evidence of performance parity? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
...
[ROCm documentation](https://rocm.docs.amd.com/en/latest/). This is an entry point, not evidence that every item above is implemented by every engine. Check model, hardware, backend and version support before making implementation claims.
