...
- CuTe layouts and tiling.
- tensor-core pipelines.
- epilogues.
- hardware-specific low-bit kernels.

## Changed-case question

How can a mathematically valid layout create inefficient memory transactions? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
...
[CUTLASS overview](https://docs.nvidia.com/cutlass/latest/overview.html). This is an entry point, not evidence that every item above is implemented by every engine. Check model, hardware, backend and version support before making implementation claims.
