...
- Long-prefill costs.
- state capacity.
- position and quality constraints.
- sparse or compressed state.

## Changed-case question

Why can a model accept a long context yet fail the useful-quality or latency target? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
