...
- prefetch.
- transfer versus recompute economics.

## Changed-case question

When should cold state be discarded rather than retained in host memory? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
