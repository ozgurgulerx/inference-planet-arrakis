...
- Hot/warm/cold state.
- NVMe bandwidth and IOPS.
- queue depth.
- endurance and write amplification.

## Changed-case question

Why can many small cache objects underperform a sequential bandwidth estimate? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
