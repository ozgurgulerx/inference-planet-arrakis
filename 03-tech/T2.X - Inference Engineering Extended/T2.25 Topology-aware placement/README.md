# T2.25 — Topology-aware placement
...
- rank and expert placement.
- warm-state location.
- failure domains.

## Changed-case question

When does placing computation near cached state conflict with collective topology? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
