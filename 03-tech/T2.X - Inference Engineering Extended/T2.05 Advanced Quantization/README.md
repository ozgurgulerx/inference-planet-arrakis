...
- Mixed precision by object.
- calibration distributions.
- native low-bit kernels.
- quality and workload sensitivity.

## Changed-case question

What changed-case evaluation would expose quantization damage hidden by an average score? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
