...
- Rank initialization.
- collective and state-transfer paths.
- cross-node placement.
- coordinated failure.

## Changed-case question

Which dependency turns a partial worker failure into a request-wide stall? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
