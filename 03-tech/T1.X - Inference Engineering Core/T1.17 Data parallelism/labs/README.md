# T1.17 — Data parallelism — Runpod labs
...
|---|---|---|---|
| T1.17-L00 | [Replica and routing model](lab-00-foundation/README.md) | intro / core | CPU |
| T1.17-L01 | [DP1 versus DP2 serving](lab-01-controlled-sweep/README.md) | medium / core | G2 |
| T1.17-L02 | [Skew and replica failure](lab-02-boundary-case/README.md) | expert / later | G2 |

## Intro — A: study/do tasks

- [ ] **T1.17-L00-A** — [Replica and routing model](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: CPU; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.17-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.17-L01-A** — [DP1 versus DP2 serving](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G2; dependencies: T1.17-L00.

## Medium — B: completion evidence

- [ ] **T1.17-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.17-L02-A** — [Skew and replica failure](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G2; dependencies: T1.17-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.17-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
