# T1.05-L01 — P-heavy versus D-heavy matrix

Status: planned, not executed · Scope: core · Level: medium · Hardware: G1 · Dependencies: T1.05-L00

Read the [environment and measurement contract](../environment.md) before using paid hardware.

## Engineering question

Which workload dimension moves TTFT and TPOT, and where does interference begin?
...
1. Create `results/T1.05-L01/` and save the exact environment, command, version/digest and workload manifest there.
2. Run the T1.01 harness over a full ISL/OSL grid and retain actual token counts.
...
- Independent conditions: ISL 128/2048/6144 × OSL 1/128/512 at concurrency 1 and 8.
...
- Measure: TTFT, TPOT, E2E, throughput, memory and errors.
...
Falsifier: **The held-out quadrant contradicts the phase-based prediction.**
