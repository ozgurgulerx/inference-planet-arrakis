# T1.05-L02 — Phase interference boundary

Status: planned, not executed · Scope: later · Level: expert · Hardware: G1 · Dependencies: T1.05-L01

Read the [environment and measurement contract](../environment.md) before using paid hardware.

## Engineering question

When do long prefills damage decode latency enough to justify scheduling intervention?
...
1. Create `results/T1.05-L02/` and save the exact environment, command, version/digest and workload manifest there.
2. Mix one long prefill stream with short decoding requests, then change only the scheduling control.
...
- Independent conditions: isolated short, isolated long and mixed; scheduling baseline versus one intervention.
...
- Measure: short-request ITL/TPOT and tail, long TTFT, total goodput.
...
Falsifier: **The intervention shifts population or quality rather than phase interference.**
