# T1.42 — GPU Observability — Runpod labs
...
|---|---|---|---|
| T1.42-L00 | [GPU telemetry baseline](lab-00-foundation/README.md) | intro / core | G1; DCGM conditional |
| T1.42-L01 | [Request-correlated dashboard](lab-01-controlled-sweep/README.md) | medium / core | G1 |
| T1.42-L02 | [Missing-signal diagnosis](lab-02-boundary-case/README.md) | expert / later | CPU analysis using G1 artifacts |

## Intro — A: study/do tasks

- [ ] **T1.42-L00-A** — [GPU telemetry baseline](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; DCGM conditional; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.42-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.42-L01-A** — [Request-correlated dashboard](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dependencies: T1.42-L00.

## Medium — B: completion evidence

- [ ] **T1.42-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.42-L02-A** — [Missing-signal diagnosis](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: CPU analysis using G1 artifacts; dependencies: T1.42-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.42-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
