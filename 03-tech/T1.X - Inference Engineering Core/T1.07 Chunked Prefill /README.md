...
- decode interference.
- chunk size and launch overhead.
- long-prompt fairness.

## Changed-case question

When can smaller chunks improve inter-token latency but worsen TTFT? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
