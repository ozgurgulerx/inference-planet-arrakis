...
- Iteration-level arrivals and departures.
- token budgets.
...
Why can admitting more sequences increase aggregate tokens/s but worsen useful goodput? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
...
iteration-level scheduling; arrivals/departures; why static batching wastes capacity

concurrency sweep on Qwen3-4B
