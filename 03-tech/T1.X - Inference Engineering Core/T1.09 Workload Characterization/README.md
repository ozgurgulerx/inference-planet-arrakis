# T1.09 — Workload Characterization
...
- Joint input/output length distributions.
- open-loop arrivals and bursts.
- prefix reuse and sessions.
- tenant and modality mix.

## Changed-case question

Which workload change would invalidate a benchmark using one fixed prompt length? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.

## Connections

[T1.01 — LLM Inference Lifecycle](../T1.01%20LLM%20Inference%20Lifecycle/README.md), [T2.33 — Benchmark Methodology](../../T2.X%20-%20Inference%20Engineering%20Extended/T2.33%20Benchmark%20Methodology%20/README.md). Use the coverage matrix to locate workload-specific extensions.
