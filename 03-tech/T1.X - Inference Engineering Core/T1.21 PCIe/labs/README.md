...
|---|---|---|---|
| T1.21-L00 | [PCIe topology and host path](lab-00-foundation/README.md) | intro / core | G1; host visibility conditional |
| T1.21-L01 | [Pinned versus pageable transfer](lab-01-controlled-sweep/README.md) | medium / core | G1 |
| T1.21-L02 | [Peer-to-peer matrix](lab-02-boundary-case/README.md) | expert / later | G2 |

## Intro — A: study/do tasks

- [ ] **T1.21-L00-A** — [PCIe topology and host path](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; host visibility conditional; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.21-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.21-L01-A** — [Pinned versus pageable transfer](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dependencies: T1.21-L00.

## Medium — B: completion evidence

- [ ] **T1.21-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.21-L02-A** — [Peer-to-peer matrix](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G2; dependencies: T1.21-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.21-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
