# T1.40-L02 — Disaggregated Dynamo boundary

Status: planned, not executed · Scope: later · Level: expert · Hardware: G2 · Dependencies: T1.40-L01

Read the [environment and measurement contract](../environment.md) before using paid hardware.

## Engineering question

Does 1P1D improve the chosen workload after NIXL handoff and extra GPU cost?
...
1. Create `results/T1.40-L02/` and save the exact environment, command, version/digest and workload manifest there.
2. Use a compatibility-matched official disaggregated recipe on two GPUs; compare with an aggregated control.
...
- Independent conditions: prefill-heavy/decode-heavy × below/near saturation.
...
- Measure: pool queues, transfer, TTFT/TPOT, SLO goodput and GPU-seconds/task.
...
Falsifier: **The comparison ignores version compatibility or doubles resources without cost normalization.**
