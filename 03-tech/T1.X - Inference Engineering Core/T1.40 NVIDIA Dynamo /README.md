...
- Frontend, router and workers.
- KV location awareness.
- disaggregated pools.
- engine compatibility.

## Changed-case question

When does routing to warm state create a worse queue than routing to a cold worker? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
...
frontend/router/workers/KV-aware routing/disaggregation/runtime architecture
