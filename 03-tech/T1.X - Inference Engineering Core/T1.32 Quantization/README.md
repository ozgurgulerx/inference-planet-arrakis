...
- Weight, activation and KV precision.
- FP8, FP4 and integer formats.
- calibration and quality.
- kernel compatibility.

## Changed-case question

Why can a smaller checkpoint deliver no latency gain on the target GPU? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
