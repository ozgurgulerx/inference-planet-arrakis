...
- RoCE transport requirements.
- ECN and PFC.
- congestion and loss.
- operational comparison with InfiniBand.

## Changed-case question

How can pause propagation turn a local hotspot into broader tail latency? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
...
T1.27
RoCE
Ethernet RDMA, PFC/ECN, congestion/loss implications
compare architectural trade-offs to IB
NVIDIA Spectrum-X docs
