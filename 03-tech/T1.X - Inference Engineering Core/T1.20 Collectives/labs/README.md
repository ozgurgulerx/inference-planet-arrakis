...
|---|---|---|---|
| T1.20-L00 | [Collective semantics](lab-00-foundation/README.md) | intro / core | G2 |
| T1.20-L01 | [Latency-bandwidth sweep](lab-01-controlled-sweep/README.md) | medium / core | G2 |
| T1.20-L02 | [Overlap and contention](lab-02-boundary-case/README.md) | expert / later | G2 |

## Intro — A: study/do tasks

- [ ] **T1.20-L00-A** — [Collective semantics](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G2; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.20-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.20-L01-A** — [Latency-bandwidth sweep](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G2; dependencies: T1.20-L00.

## Medium — B: completion evidence

- [ ] **T1.20-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.20-L02-A** — [Overlap and contention](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G2; dependencies: T1.20-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.20-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
