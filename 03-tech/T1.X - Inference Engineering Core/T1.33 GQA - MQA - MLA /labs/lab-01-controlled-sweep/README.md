# T1.33-L01 — Estimator validation

Status: planned, not executed · Scope: core · Level: medium · Hardware: G1 · Dependencies: T1.33-L00

Read the [environment and measurement contract](../environment.md) before using paid hardware.

## Engineering question

Does observed memory growth follow the architecture-specific state estimate?
...
1. Create `results/T1.33-L01/` and save the exact environment, command, version/digest and workload manifest there.
2. Run supported small models or synthetic attention modules at increasing sequence lengths.
...
- Independent conditions: sequence 128/2048/6144; matched dtype/batch.
...
- Measure: allocated memory slope, estimate error and output checksum.
...
Falsifier: **Model-size or allocator changes are confused with state slope.**
