# T1.18 — Expert parallelism — Runpod labs
...
|---|---|---|---|
| T1.18-L00 | [Expert-routing histogram](lab-00-foundation/README.md) | intro / core | CPU then G1 |
| T1.18-L01 | [Dispatch/combine trace](lab-01-controlled-sweep/README.md) | medium / core | G1 supported MoE |
| T1.18-L02 | [EP placement and skew](lab-02-boundary-case/README.md) | expert / later | G2; backend support conditional |

## Intro — A: study/do tasks

- [ ] **T1.18-L00-A** — [Expert-routing histogram](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: CPU then G1; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.18-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.18-L01-A** — [Dispatch/combine trace](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1 supported MoE; dependencies: T1.18-L00.

## Medium — B: completion evidence

- [ ] **T1.18-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.18-L02-A** — [EP placement and skew](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G2; backend support conditional; dependencies: T1.18-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.18-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
