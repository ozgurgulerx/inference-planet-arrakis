# T1.10 — GPU Architecture Basics — Runpod labs
...
|---|---|---|---|
| T1.10-L00 | [GPU execution inventory](lab-00-foundation/README.md) | intro / core | G1 |
| T1.10-L01 | [Shape, occupancy and tensor cores](lab-01-controlled-sweep/README.md) | medium / core | G1 |
| T1.10-L02 | [Clock/power/thermal boundary](lab-02-boundary-case/README.md) | expert / later | G1; controls may be read-only |

## Intro — A: study/do tasks

- [ ] **T1.10-L00-A** — [GPU execution inventory](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.10-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.10-L01-A** — [Shape, occupancy and tensor cores](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dependencies: T1.10-L00.

## Medium — B: completion evidence

- [ ] **T1.10-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.10-L02-A** — [Clock/power/thermal boundary](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; controls may be read-only; dependencies: T1.10-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.10-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
