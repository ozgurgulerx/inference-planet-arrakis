...
- Queue, compute, bandwidth, communication and launch bottlenecks.
- discriminating measurements.
- counterfactual tests.

## Changed-case question

What observation would make you abandon your first bottleneck hypothesis? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
