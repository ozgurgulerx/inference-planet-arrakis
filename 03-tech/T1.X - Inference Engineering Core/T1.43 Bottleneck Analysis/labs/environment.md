# T1.43 — Bottleneck Analysis — Runpod environment contract

Status: specification only. Generating this pack did not provision a Pod or validate a GPU result. Source check: 2026-09-21.

## Resource gate

Highest requested tier: **G1: one Runpod NVIDIA GPU; use the smallest supported 24–48 GB option for the pinned workload**.
