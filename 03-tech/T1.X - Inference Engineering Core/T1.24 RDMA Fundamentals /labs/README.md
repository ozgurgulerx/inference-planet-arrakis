# T1.24 — RDMA Fundamentals — Runpod labs
...
|---|---|---|---|
| T1.24-L00 | [RDMA object lifecycle](lab-00-foundation/README.md) | intro / core | CPU concepts; N2 for hardware gate |
| T1.24-L01 | [Latency/bandwidth size curve](lab-01-controlled-sweep/README.md) | medium / core | N2 RDMA required |
| T1.24-L02 | [Completion and failure semantics](lab-02-boundary-case/README.md) | expert / later | N2 isolated endpoints |

## Intro — A: study/do tasks

- [ ] **T1.24-L00-A** — [RDMA object lifecycle](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: CPU concepts; N2 for hardware gate; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.24-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.24-L01-A** — [Latency/bandwidth size curve](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: N2 RDMA required; dependencies: T1.24-L00.

## Medium — B: completion evidence

- [ ] **T1.24-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.24-L02-A** — [Completion and failure semantics](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: N2 isolated endpoints; dependencies: T1.24-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.24-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
