...
- one-sided versus two-sided operations.
- completion semantics.
- transport requirements.

## Changed-case question

Does a local completion prove that a consumer can safely reuse remote state? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
