# T1.34-L01 — Length and phase sweep

Status: planned, not executed · Scope: core · Level: medium · Hardware: G1 · Dependencies: T1.34-L00

Read the [environment and measurement contract](../environment.md) before using paid hardware.

## Engineering question

How do memory and speedups change from short decode-like to long prefill-like shapes?
...
1. Create `results/T1.34-L01/` and save the exact environment, command, version/digest and workload manifest there.
2. Benchmark matched Q/K/V shapes over sequence and batch, with warmups and synchronized timing.
...
- Independent conditions: short/medium/long sequence × batch 1/8.
...
- Measure: latency, peak memory, achieved bandwidth/FLOP proxy and error.
...
Falsifier: **An OOM condition is dropped instead of recorded as capacity evidence.**
