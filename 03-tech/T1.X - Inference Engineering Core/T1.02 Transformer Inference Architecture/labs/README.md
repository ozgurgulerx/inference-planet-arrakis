# T1.02 — Transformer Inference Architecture — Runpod labs
...
|---|---|---|---|
| T1.02-L00 | [One-layer inference trace](lab-00-foundation/README.md) | intro / core | CPU then G1 |
| T1.02-L01 | [Phase and context-depth matrix](lab-01-controlled-sweep/README.md) | medium / core | G1 |
| T1.02-L02 | [Architecture boundary change](lab-02-boundary-case/README.md) | expert / later | G1; changed model support conditional |

## Intro — A: study/do tasks

- [ ] **T1.02-L00-A** — [One-layer inference trace](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: CPU then G1; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.02-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.02-L01-A** — [Phase and context-depth matrix](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dependencies: T1.02-L00.

## Medium — B: completion evidence

- [ ] **T1.02-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.02-L02-A** — [Architecture boundary change](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; changed model support conditional; dependencies: T1.02-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.02-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
