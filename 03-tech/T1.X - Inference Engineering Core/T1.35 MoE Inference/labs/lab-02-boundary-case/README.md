# T1.35-L02 — Expert-parallel extension

Status: planned, not executed · Scope: later · Level: expert · Hardware: G2 backend conditional · Dependencies: T1.35-L01

Read the [environment and measurement contract](../environment.md) before using paid hardware.

## Engineering question

When does EP communication outweigh parallel expert compute?
...
1. Create `results/T1.35-L02/` and save the exact environment, command, version/digest and workload manifest there.
2. Compare EP1/EP2 only on a version-supported G2 configuration and record all-to-all explicitly.
...
- Independent conditions: balanced and skewed routing at matched tokens.
...
- Measure: dispatch/combine, all-to-all, expert compute, tail and cost.
...
Falsifier: **Different checkpoints or routing decisions invalidate the A/B.**
