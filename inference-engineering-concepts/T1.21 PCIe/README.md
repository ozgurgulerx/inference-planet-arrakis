...
- PCIe generations and effective bandwidth.
- shared switches.
- host transfers.
...
How can two GPUs with the same model have different transfer performance? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
