...
- request routing.
- weight duplication.
- dense versus MoE attention data parallelism.

## Changed-case question

When should another replica replace a larger tensor-parallel group? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
