...
- CPU/GPU timelines.
- kernel and transfer attribution.
- sampling versus tracing.
- profiler perturbation.

## Changed-case question

How would you test whether the profiler itself changed the scheduling regime? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
