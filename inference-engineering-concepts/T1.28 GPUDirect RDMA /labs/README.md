# T1.28 — GPUDirect RDMA — Runpod labs
...
|---|---|---|---|
| T1.28-L00 | [GPUDirect eligibility](lab-00-foundation/README.md) | intro / core | N2 GDR conditional |
| T1.28-L01 | [Direct versus staged path](lab-01-controlled-sweep/README.md) | medium / core | N2 GDR required |
| T1.28-L02 | [Synchronization and topology boundary](lab-02-boundary-case/README.md) | expert / later | N2 multi-device topology conditional |

## Intro — A: study/do tasks

- [ ] **T1.28-L00-A** — [GPUDirect eligibility](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: N2 GDR conditional; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.28-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.28-L01-A** — [Direct versus staged path](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: N2 GDR required; dependencies: T1.28-L00.

## Medium — B: completion evidence

- [ ] **T1.28-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.28-L02-A** — [Synchronization and topology boundary](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: N2 multi-device topology conditional; dependencies: T1.28-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.28-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
