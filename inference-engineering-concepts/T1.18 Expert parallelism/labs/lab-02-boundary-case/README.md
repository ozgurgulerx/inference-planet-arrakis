# T1.18-L02 — EP placement and skew

Status: planned, not executed · Scope: later · Level: expert · Hardware: G2; backend support conditional · Dependencies: T1.18-L01

Read the [environment and measurement contract](../environment.md) before using paid hardware.

## Engineering question

When does adding an expert-parallel rank worsen the tail because all-to-all and imbalance dominate?
...
1. Create `results/T1.18-L02/` and save the exact environment, command, version/digest and workload manifest there.
2. Compare one-rank and two-rank expert placement on a verified topology with identical routing inputs.
...
- Independent conditions: balanced and biased routing at EP1/EP2.
...
- Measure: all-to-all time, max-rank load, tail latency and goodput.
...
Falsifier: **The model or routing decisions differ between EP conditions.**
