...
- pipeline bubbles.
- microbatches.
- heterogeneous stage graphs.

## Changed-case question

How does low-concurrency interactive serving change a pipeline-parallel decision? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
