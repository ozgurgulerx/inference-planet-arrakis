...
- request-correlated telemetry.

## Changed-case question

Which missing request-level metric prevents GPU dashboards from explaining tail TTFT? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
