# T1.07 — Chunked Prefill — Runpod labs
...
Semantic owner links: [T1.01-L16](../../T1.01%20LLM%20Inference%20Lifecycle/labs/lab-16-chunked-prefill/README.md)
...
|---|---|---|---|
| T1.07-L00 | [Long-prompt interference](lab-00-foundation/README.md) | intro / core | G1 |
| T1.07-L01 | [Chunk-size frontier](lab-01-controlled-sweep/README.md) | medium / core | G1 |
| T1.07-L02 | [Fairness changed case](lab-02-boundary-case/README.md) | expert / later | G1 |

## Intro — A: study/do tasks

- [ ] **T1.07-L00-A** — [Long-prompt interference](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.07-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.07-L01-A** — [Chunk-size frontier](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dependencies: T1.07-L00.

## Medium — B: completion evidence

- [ ] **T1.07-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.07-L02-A** — [Fairness changed case](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dependencies: T1.07-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.07-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
