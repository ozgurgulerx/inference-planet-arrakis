# T1.29-L01 — Transfer versus recompute

Status: planned, not executed · Scope: core · Level: medium · Hardware: G2; local connector · Dependencies: T1.29-L00

Read the [environment and measurement contract](../environment.md) before using paid hardware.

## Engineering question

At what prefix length does moving KV beat recomputing it on this path?
...
1. Create `results/T1.29-L01/` and save the exact environment, command, version/digest and workload manifest there.
2. Measure local transfer and prefill recompute separately over prefix lengths, including setup and synchronization.
...
- Independent conditions: prefix 128/2048/6144; warm/cold registration; fixed model.
...
- Measure: transfer time, recompute time, payload, TTFT and break-even.
...
Falsifier: **The comparison omits queue/setup cost or uses mismatched KV dtype/layout.**
