# T1.29-L02 — Network changed case

Status: planned, not executed · Scope: later · Level: expert · Hardware: N2 conditional; analytical fallback · Dependencies: T1.29-L01

Read the [environment and measurement contract](../environment.md) before using paid hardware.

## Engineering question

How does the break-even move with realistic bandwidth, latency and queueing?
...
1. Create `results/T1.29-L02/` and save the exact environment, command, version/digest and workload manifest there.
2. Use measured network data when available; otherwise perform a labeled sensitivity analysis, not a hardware claim.
...
- Independent conditions: observed/local plus bounded bandwidth/latency scenarios.
...
- Measure: break-even surface and uncertainty.
...
Falsifier: **Modeled network results are reported as Runpod RDMA measurements.**
