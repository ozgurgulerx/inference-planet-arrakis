# T1.39-L01 — Profile and in-flight batching sweep

Status: planned, not executed · Scope: core · Level: medium · Hardware: G1 · Dependencies: T1.39-L00

Read the [environment and measurement contract](../environment.md) before using paid hardware.

## Engineering question

How do build-time/runtime profiles constrain batch, input and output behavior?
...
1. Create `results/T1.39-L01/` and save the exact environment, command, version/digest and workload manifest there.
2. Benchmark shapes inside and at the edge of the built profiles with in-flight batching controls recorded.
...
- Independent conditions: short/long × concurrency 1/8 within profile.
...
- Measure: TTFT/TPOT, throughput, memory, selected profile and errors.
...
Falsifier: **Out-of-profile fallback/rebuild cost is silently excluded.**
