# T1.01-L23 — Quantization decomposition

**LATER · Expert · G1 exact supported precision**
Dependencies: [L12](../lab-12-kv-math/README.md), [L18](../lab-18-structured-output/README.md), [L21](../lab-21-projection-roofline/README.md)
Execution status: proposed; GPU behavior unverified. Source check: 2026-09-20.

## Engineering question

Which gain comes from fit, capacity, bandwidth or arithmetic?
...
1. **Prepare, 15–30 active minutes.** Select an exact supported checkpoint/backend and independently compare weight and KV precision. Start with a fixed quality fixture set and BF16 baseline.
...
3. **Run, bounded session.** Record checkpoint bytes, resident memory, KV capacity, latency, throughput and accepted-task rate under identical workload. Verify GPU-specific format support.
4. **Analyze and defend, 15–45 active minutes.** Quality/performance/capacity comparison with uncertainties and compatibility ledger.
...
Quality/performance/capacity comparison with uncertainties and compatibility ledger.
...
Show a memory reduction without claiming an unobserved latency gain.

Deferred; A40 is not interchangeable with native-FP8 hardware, and compressed weights are not total runtime state.
...
[release](https://github.com/vllm-project/vllm/releases/tag/v0.29.0) · [model](https://huggingface.co/Qwen/Qwen3-4B/tree/3101254bbe4169895668a0e7653c3fd1f313576e)
