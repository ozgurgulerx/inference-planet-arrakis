# T1.35 — MoE Inference — Runpod labs
...
|---|---|---|---|
| T1.35-L00 | [MoE memory and routing ledger](lab-00-foundation/README.md) | intro / core | CPU then G1 |
| T1.35-L01 | [Skew and capacity-factor sweep](lab-01-controlled-sweep/README.md) | medium / core | G1 |
| T1.35-L02 | [Expert-parallel extension](lab-02-boundary-case/README.md) | expert / later | G2 backend conditional |

## Intro — A: study/do tasks

- [ ] **T1.35-L00-A** — [MoE memory and routing ledger](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: CPU then G1; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.35-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.35-L01-A** — [Skew and capacity-factor sweep](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dependencies: T1.35-L00.

## Medium — B: completion evidence

- [ ] **T1.35-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.35-L02-A** — [Expert-parallel extension](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G2 backend conditional; dependencies: T1.35-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.35-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
