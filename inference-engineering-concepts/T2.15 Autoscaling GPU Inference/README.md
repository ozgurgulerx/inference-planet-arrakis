# T2.15 — Autoscaling GPU Inference
...
- Lagged scaling signals.
- phase-specific pools.
- warm state and cold starts.
- hysteresis.

## Changed-case question

Why can scaling out make a cache-heavy workload temporarily slower? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
