# T1.31 — Prefill/decode disaggregation — Runpod labs
...
Semantic owner links: [T1.01-L30](../../T1.01%20LLM%20Inference%20Lifecycle/labs/lab-30-disaggregation/README.md)
...
|---|---|---|---|
| T1.31-L00 | [Aggregated versus 1P1D correctness](lab-00-foundation/README.md) | intro / core | G2 |
| T1.31-L01 | [Pool and handoff sweep](lab-01-controlled-sweep/README.md) | medium / core | G2 |
| T1.31-L02 | [P:D ratio sensitivity](lab-02-boundary-case/README.md) | expert / later | G2+; extra GPUs conditional |

## Intro — A: study/do tasks

- [ ] **T1.31-L00-A** — [Aggregated versus 1P1D correctness](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G2; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.31-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.31-L01-A** — [Pool and handoff sweep](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G2; dependencies: T1.31-L00.

## Medium — B: completion evidence

- [ ] **T1.31-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.31-L02-A** — [P:D ratio sensitivity](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G2+; extra GPUs conditional; dependencies: T1.31-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.31-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
