...
|---|---|---|---|
| T1.23-L00 | [NUMA/GPU/NIC map](lab-00-foundation/README.md) | intro / core | G1; host visibility conditional |
| T1.23-L01 | [Local versus remote host memory](lab-01-controlled-sweep/README.md) | medium / core | G1; dual-socket exposure conditional |
| T1.23-L02 | [GPU/NIC affinity changed case](lab-02-boundary-case/README.md) | expert / later | N2/host access conditional |

## Intro — A: study/do tasks

- [ ] **T1.23-L00-A** — [NUMA/GPU/NIC map](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; host visibility conditional; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.23-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.23-L01-A** — [Local versus remote host memory](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dual-socket exposure conditional; dependencies: T1.23-L00.

## Medium — B: completion evidence

- [ ] **T1.23-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.23-L02-A** — [GPU/NIC affinity changed case](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: N2/host access conditional; dependencies: T1.23-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.23-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
