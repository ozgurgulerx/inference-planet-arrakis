...
- GPU/storage paths.
- alignment and filesystem constraints.
- fallback detection.
- IO/computation overlap.

## Changed-case question

How would you verify that a storage read used the intended direct path? Explain the mechanism, state your assumptions, and name a measurement that could disprove your explanation.
