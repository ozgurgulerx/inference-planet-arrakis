# T1.32 — Quantization — Runpod labs
...
Semantic owner links: [T1.01-L23](../../T1.01%20LLM%20Inference%20Lifecycle/labs/lab-23-quantization/README.md)
...
|---|---|---|---|
| T1.32-L00 | [Precision decomposition](lab-00-foundation/README.md) | intro / core | G1 |
| T1.32-L01 | [Quality/performance/capacity matrix](lab-01-controlled-sweep/README.md) | medium / core | G1 |
| T1.32-L02 | [Kernel-support boundary](lab-02-boundary-case/README.md) | expert / later | G1 profiler permissions conditional |

## Intro — A: study/do tasks

- [ ] **T1.32-L00-A** — [Precision decomposition](lab-00-foundation/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dependencies: none.

## Intro — B: completion evidence

- [ ] **T1.32-L00-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Medium — A: study/do tasks

- [ ] **T1.32-L01-A** — [Quality/performance/capacity matrix](lab-01-controlled-sweep/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1; dependencies: T1.32-L00.

## Medium — B: completion evidence

- [ ] **T1.32-L01-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
## Expert — A: study/do tasks (deferred until chosen)

- [ ] **T1.32-L02-A** — [Kernel-support boundary](lab-02-boundary-case/README.md): predict, build, run the bounded conditions and retain artifacts. Hardware: G1 profiler permissions conditional; dependencies: T1.32-L01.

## Expert — B: completion evidence (deferred until chosen)

- [ ] **T1.32-L02-B** — Pass the guide's correctness and evidence checks, explain the mechanism, reject a competing explanation, and defend one changed case. An offline result does not satisfy a GPU/network gate.
